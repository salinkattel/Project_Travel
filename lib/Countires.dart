            ...
            child: Stack(
              children: [
                            ...
                            child: Container(
                              ...
                              child: Stack(
                                children: [
                                  ...
                                  Positioned(
                                      top: 480,
                                      left: 34,
                                      child: Text("Indonesia",style: TextStyle(color: Colors.white,fontFamily: "Mavric",fontSize: 10),)),
                                  Positioned(
                                    top: 478,
                                    left: 150,
                                    child: Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                image: DecorationImage(
                                  image: AssetImage("assets/image/Indo.jpeg"),
                                  fit: BoxFit.cover,
                                ),
                              ),
                            ),
                          ...
                          Padding(
                            ...
                            child: Container(
                              ...
                              child: Stack(
                                children: [
                                  ...
                                  Positioned(
                                      top: 480,
                                      left: 34,
                                      child: Text("Nepal",style: TextStyle(color: Colors.white,fontFamily: "Mavric",fontSize: 10),)),
                                  Positioned(
                                    top: 478,
                                    left: 150,
                                    child: InkWell(
                              ...
                              decoration: BoxDecoration(
                                borderRadius: BorderRadius.circular(40),
                                image: DecorationImage(
                                  image: AssetImage("assets/image/Nepal.jpg"),
                                  fit: BoxFit.cover,
                                ),
                              ),
                            ),
                          ...
                          Padding(
                            ...
                            child: Container(
                              ...
                              child: Stack(
                                children: [
                                  ...
                                  Positioned(
                                      top: 480,
                                      left: 34,
                                      child: Text("Japan",style: TextStyle(color: Colors.white,fontFamily: "Mavric",fontSize: 10),)),
                                  Positioned(
                                    top: 478,
                                    left: 150,
                                    child: Container(
                              ...
                              decoration: BoxDecoration(
                                borderRadius: BorderRadius.circular(40),
                                image: DecorationImage(
                                  image: AssetImage("assets/image/Japan.jpg"),
                                  fit: BoxFit.cover,
                                ),
                              ),
                            ),
                          ...
                          Padding(
                            ...
                            child: Container(
                              ...
                              child: Stack(
                                children: [
                                  ...
                                  Positioned(
                                      top: 480,
                                      left: 34,
                                      child: Text("France",style: TextStyle(color: Colors.white,fontFamily: "Mavric",fontSize: 10),)),
                                  Positioned(
                                    top: 478,
                                    left: 150,
                                    child: Container(
                              ...
                              decoration: BoxDecoration(
                                borderRadius: BorderRadius.circular(40),
                                image: DecorationImage(
                                  image: AssetImage("assets/image/France.jpg"),
                                  fit: BoxFit.cover,
                                ),
                              ),
                            ),
                ...
                Positioned(
                  ...
                  left: 20,
                  child: RotatedBox(quarterTurns: 3,
                    child: Text('Countries',style: TextStyle(color: Colors.red,fontFamily: "Mavric",fontSize: 18),),
                  ),
                ),
                Positioned(
                  top: 240,
