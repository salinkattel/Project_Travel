...
import 'package:application_mavric/Search.dart';
            ...
            child: Stack(
              children: [
                            ...
                            child: Container(
                              ...
                              child: Stack(
                                children: [
                                  ...
                                  Positioned(
                                      top: 480,
                                      left: 34,
                                      child: Text("Jhor",style: TextStyle(color: Colors.white,fontFamily: "Mavric",fontSize: 10),)),
                                  Positioned(
                                    top: 478,
                                    left: 150,
                                    child: Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                image: DecorationImage(
                                  image: AssetImage("assets/image/Jhor.jpg"),
                                  fit: BoxFit.cover,
                                ),
                              ),
                            ),
                          ...
                          Padding(
                            ...
                            child: Container(
                              ...
                              child: Stack(
                                children: [
                                  ...
                                  Positioned(
                                      top: 480,
                                      left: 34,
                                      child: Text("Upper Mustang",style: TextStyle(color: Colors.white,fontFamily: "Mavric",fontSize: 10),)),
                                  Positioned(
                                    top: 478,
                                    left: 150,
                                    child: Container(
                              ...
                              decoration: BoxDecoration(
                                borderRadius: BorderRadius.circular(40),
                                image: DecorationImage(
                                  image: AssetImage("assets/image/upper_mustang_village.jpg"),
                                  fit: BoxFit.cover,
                                ),
                              ),
                            ),
                          ...
                          Padding(
                            ...
                            child: Container(
                              ...
                              child: Stack(
                                children: [
                                  ...
                                  Positioned(
                                      top: 480,
                                      left: 34,
                                      child: Text("Bishnu Dwar",style: TextStyle(color: Colors.white,fontFamily: "Mavric",fontSize: 10),)),
                                  Positioned(
                                    top: 478,
                                    left: 150,
                                    child: Container(
                              ...
                              decoration: BoxDecoration(
                                borderRadius: BorderRadius.circular(40),
                                image: DecorationImage(
                                  image: AssetImage("assets/image/Bishnudwar.jpg"),
                                  fit: BoxFit.cover,
                                ),
                              ),
                            ),
                          ...
                          Padding(
                            ...
                            child: Container(
                              ...
                              child: Stack(
                                children: [
                                  ...
                                  Positioned(
                                      top: 480,
                                      left: 34,
                                      child: Text("Dhap Dam",style: TextStyle(color: Colors.white,fontFamily: "Mavric",fontSize: 10),)),
                                  Positioned(
                                    top: 478,
                                    left: 150,
                                    child: Container(
                              ...
                              decoration: BoxDecoration(
                                borderRadius: BorderRadius.circular(40),
                                image: DecorationImage(
                                  image: AssetImage("assets/image/Dhap_dam.jpg"),
                                  fit: BoxFit.cover,
                                ),
                              ),
                            ),
                  ...
                  child: RotatedBox(quarterTurns: 3,
                    child: InkWell(
                      onTap: (){
                        ...
                        child: Text('Cities',style: TextStyle(color: Colors.grey,fontFamily: "Mavric"),)),
                  ),
                ),
                Positioned(
                  top: 395,
                ...
                Positioned(
                  ...
                  left: 20,
                  child: RotatedBox(quarterTurns: 3,
                    child: Text('Destination',style: TextStyle(color: Colors.red,fontFamily: "Mavric",fontSize: 18),),
                  ),
                ),
                Positioned(
                    top: 130,
